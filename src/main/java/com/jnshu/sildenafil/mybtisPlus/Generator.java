package com.jnshu.sildenafil.mybtisPlus;
...
//        strategy.setInclude("t_user","t_user_role","t_role_menu","t_role","t_menu","t_dict","t_dept"); // 需要生成的表
        // 需要生成的表
//        strategy.setInclude("article","collection_asset","forum","like_asset","review","sign","student","teacher","video");
        strategy.setInclude("front_log");
